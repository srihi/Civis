...
public class Token {
  ...
  public boolean equals(Object o) {
    ...
    Token token = (Token) o;
    return (this.grantType == null ? token.grantType == null : this.grantType.equals(token.grantType)) &&
        (this.clientId == null ? token.clientId == null : this.clientId.equals(token.clientId)) &&
        (this.clientSecret == null ? token.clientSecret == null : this.clientSecret.equals(token.clientSecret)) &&
        (this.redirectUri == null ? token.redirectUri == null : this.redirectUri.equals(token.redirectUri)) &&
        (this.code == null ? token.code == null : this.code.equals(token.code));
  }
